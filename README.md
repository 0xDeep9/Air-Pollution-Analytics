...
* Selecting the right cities for product launch
* Understanding pollution severity and seasonality
* Identifying high-demand consumer segments
* Analyzing competitor strengths and gaps
* Recommending product features based on user needs

The insights from this project provide a **strategic roadmap** for AirPure’s market entry.
